    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT courseCode, courseDesc from course LEFT OUTER JOIN teacher ON course.teacherId = teacher.tid WHERE teacher.dept = 'Computer Science'";
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT DISTINCT dept, COUNT(dept) teacherCount from teacher GROUP BY dept";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(cs.course_id) as numStudents from course c INNER JOIN course_Student cs ON c.cid = cs.course_id GROUP BY c.cid";
